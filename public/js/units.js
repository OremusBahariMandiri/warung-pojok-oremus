...
$(document).ready(function () {
    ...
    const dataTable = $('#unitsDataTable').DataTable({
        ...
        language: {
            emptyTable: "Belum ada master satuan di database. Klik tombol 'Tambah Satuan' untuk membuat baru.",
    ...
    function applyFilters() {
        ...
        dataTable.column(3).search(category ? '^' + category + '$' : '', true, false);
...
function openDeleteModal(id, name, productCount) {
    ...
    const modal = new bootstrap.Modal(document.getElementById('modalDeleteUnit'));
    modal.show();
}
