                    ...
                    <td class="text-center">
                        ...
                        <div class="d-none d-md-inline-flex gap-1 justify-content-center">
                            ...
                            <button type="button"
                                    ...
                                    onclick="openDeleteModal({{ $item->id }}, '{{ addslashes($item->unit_name) }}', {{ (int)($item->products_count ?? 0) }})">
                                <i class="bi bi-trash"></i>
                            </button>
                        </div>

                        <!-- Mobile Dropdown (disembunyikan oleh CSS di mobile, tapi tetap ada untuk md ke atas jika diperlukan) -->
