...
@section('page-title', 'Tambah Master Satuan')
            ...
            <div class="card-box">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control rounded-3 @error('unit_name') is-invalid @enderror" 
                            id="unit_name" name="unit_name" value="{{ old('unit_name') }}" required autofocus>
                        @error('unit_name')
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control font-monospace rounded-3 @error('short_name') is-invalid @enderror" 
                            id="short_name" name="short_name" value="{{ old('short_name') }}" required>
                        @error('short_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control rounded-3 @error('type') is-invalid @enderror" 
                        id="type" name="type" value="{{ old('type') }}" list="typeSuggestions"required>
