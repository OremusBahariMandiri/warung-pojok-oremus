...
<div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-2 mb-3">
    <div>
        ...
        <p class="text-muted small mb-0">Kelola dan atur daftar bahan baku, porsi, dan komponen biaya pokok produksi (HPP).</p>
    </div>
</div>
...
<div class="card-box p-0 border rounded-3 overflow-hidden shadow-sm bg-white mb-4">
    ...
    <div class="p-3 border-bottom d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3">
        ...
        <div class="d-flex align-items-center gap-2">
            <button type="button" class="btn btn-sm btn-outline-secondary rounded-2 d-inline-flex align-items-center gap-2 px-3 position-relative" data-bs-toggle="modal" data-bs-target="#modalFilterHpp">
            ...
            <a href="{{ route('hpp.create') }}" class="btn btn-sm btn-success rounded-2 text-white fw-semibold d-inline-flex align-items-center gap-2 px-3">
    ...
    <table class="table table-bordered table-hover align-middle mb-0 w-100 text-nowrap" id="hppDataTable">
        <thead>
            <tr>
                ...
                <th class="text-center" style="width: 150px;">Produk Terkait</th>
